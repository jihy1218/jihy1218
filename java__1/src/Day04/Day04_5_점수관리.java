...
public class Day04_5_점수관리 {
	...
	// 배열을 이용한 점수관리 프로그램
		// 1. 학생수를 입력받아 학생수만큼 배열에길이 할당
		// 2. 메뉴 [ 1. 학생수 2. 점수	입력 3. 분석[등수(내림차순) , 평균] 4.종료]
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			if( ch==1 ) { 
				...
				// 배열의 메모리 할당
				학생점수목록 = new Integer[size]; // 입력변수 : 입력 메모리 할당
...
//				
			...
			Arrays.sort( 학생점수목록 ); // 오름차순
			Arrays.sort( 학생점수목록, Collections.reverseOrder() );
					// collections.reverseOrder() : 순서 뒤집기 [ 기본잘형은 불가 // 객채만 뒤집기 
