...
public class Day11_4 {
	...
	public static void main(String[] args) throws IOException {
		...
		int readcount = System.in.read(bytes2); // 무조건 예외 발생
			// 입출력 관련 항상 예외처리 발생
		...
		byte[] byte3 = str.getBytes(); // String 바이트로 변환후 배열에 대입
		System.out.println(byte3.length);	// 한글 글자수 *2 = 10바이트
		//byte ==> 문자열
		...
		// p.505
			// 7. length() : 문자열의 길이
			System.out.println(subject.length()); // 8칸 인덱스 0~7
		...
		// p.507 
			...
			System.out.println(ssn2.substring(0,6)); // 시작 인덱스 , 끝 인덱스 
