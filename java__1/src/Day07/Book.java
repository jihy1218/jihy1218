...
public class Book {
			...
			for( int i = 0 ; i<BookApplication.books.length; i++ ) {
				if(BookApplication.books[i] != null &&
					...
					if( BookApplication.books[i].getB_rental() ) {
						System.out.println("[[알림]] : 현재 대여 가능 도서입니다. 대여성공!");
	...
	public boolean getB_rental() {return b_rental;}
	public void setB_rental(boolean b_rental) {this.b_rental = b_rental;}
