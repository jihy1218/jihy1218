		...
		try {
			// 1.파일출력 객체
				FileOutputStream fileOutputStream =
						new FileOutputStream("D:/JavaWeb/jihy1218/java__1/src/Day12/Memberlist.txt", true ); // true 이어쓰기
			// 2. 객체 내보내기 [ 필드 구분 ] 
