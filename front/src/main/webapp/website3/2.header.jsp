...
<title>Insert title here</title>
	<style type="text/css">
		/* 기본세팅 */
		*{margin: 0; padding: 0; box-sizing: border-box; font-family: "나눔바른고딕";} 
		li{list-style-type: none;}
		header{height: 70px; position: relative;}
		header .logo {position: absolute; top: 25px; left: 20px;}
		header .logo span{color : #1e4db8; font-weight: bold;}
		...
		/* 그리드 */
		[class*="col_"] {float: left;}		/* 기본 : 스마트폰용 */
		...
		header .menu_btn{display: none;}  /* 1200픽셀 이상이면 메뉴버튼 숨기기 */
...
<body>
	<header>
		<div class="box">
			<h1 class="logo"><a href="#"><span>THE</span>  스튜디오</a></h1>
			<ul class="menu">
