...
<title>Insert title here</title>
	<style type="text/css">
		li{list-style-type: none;}						/* 리스트 항목의 글머리 제거 */
		#sub_menu h3{
			font-size: 18px; color : #5af1be; background-color: #516e7f; padding: 12px;
		}	
		#sub_menu li{
			padding : 10px;
		...
		#figure {
			margin-top: 30px; text-align: center; 		/* 사진 가운데 정렬 */ 
		}
		#main_contents ul{
			padding : 5px;
		}
...
<body>
	<section id="contents">								<!-- 세션 태그 -->
		<nav id="sub_menu">								<!-- 메뉴 태그 [div 처럼 해도 무관] -->
			<h3>사진 이론</h3>
			<ul>
				<li>카메라 동작 원리</li>
				<li>무조건 찍어 보자!</li>
		...
		<div id="main_contents">						<!-- 메뉴 태그 [div 처럼 해도 무관] -->
			<h3>카메라 동작 원리</h3>
