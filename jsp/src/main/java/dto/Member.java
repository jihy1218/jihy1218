...
public class Member {
	...
	public int getM_no() {return m_num;}
	public void setM_no(int m_num) {this.m_num = m_num;}
	...
	public String getM_sdate() {return m_sdate;}
	public void setM_sdate(String m_sdate) {this.m_sdate = m_sdate;}
}
