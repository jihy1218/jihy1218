...
<%
	...
	// 객체화
	Porder porder = new Porder(m_num,order_name,order_phone,order_address,order_pay,order_payment,delivery_pay,order_contents);
	...
	// 순서
		// 1. 주문목록 [ 1.주문db등록한다. -> 2.주문 상품수만큼 주문상세 등록]
			// 1. 회원번호 : m_num : 세션
			// 2. 주문자 : order_name
			// 3. 받는사람연락처 : order_phone
			// 4. 받는 사람주소 : order_address
			// 5. 주문 총 금액 : order_pay
