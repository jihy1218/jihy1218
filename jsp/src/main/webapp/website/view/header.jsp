				...
				<nav class="navbar navbar-expand-lg navbar-light bg-white">
					...
					<div class="collapse navbar-collapse" id="main_menu">
						<ul class="navbar-nav col-md-12 justify-content-between">
							...
							<li class="nav-item"><a href="/jsp/website/view/member/chatting.jsp" class="nav-link">채팅</a></li>
							<li class="nav-item"><a href="/jsp/website/view/product/productcart.jsp" class="nav-link">장바구니</a></li>
